...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        if (mysqli_query($koneksi, $query)) {
            echo "<script>alert('Pembeli berhasil ditambahkan!'); window.location.href='pembeliView.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan pembeli. Error: " . mysqli_error($koneksi) . "');</script>";
        }
    }
}
?>
...
<body>
    <div class="form-container">
        ...
        <form action="pembeliAdd.php" method="POST">
            ...
            <button type="submit" name="submit">Tambah Pembeli</button>
        </form>
    </div>
